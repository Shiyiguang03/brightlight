...
export default function RequestRepairPage() {
  ...
  // Key to force resetting the file input element on deletions
  ...
  const removeImage = (index: number) => {
    ...
    // Reset input key so browser allows uploading the same file again
      ...
      <div className="py-12 px-4" style={{ padding: '48px 16px' }}>
        <div className="max-w-3xl mx-auto" style={{ width: '100%', maxWidth: '768px', margin: '0 auto' }}>
          ...
          <form onSubmit={handleSubmit} className="bg-white border rounded-3xl shadow-xl p-8"
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  ...
                  <input type="text" name="brand" value={formData.brand} onChange={handleChange} placeholder="e.g. Dell, HP, Lenovo" style={{ width: '100%', height: '52px', padding: '0 16px', border: '1px solid #e6dfd5', borderRadius: '12px', fontSize: '15px', color: '#453227', backgroundColor: '#ffffff', boxSizing: 'border-box', outline: 'none' }} />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: '12px', fontWeight: '700', color: '#6b5446', marginBottom: '6px' }}>MODEL</label>
                  <input type="text" name="model" value={formData.model} onChange={handleChange} placeholder="e.g. XPS 13" style={{ width: '100%', height: '52px', padding: '0 16px', border: '1px solid #e6dfd5', borderRadius: '12px', fontSize: '15px', color: '#453227', backgroundColor: '#ffffff', boxSizing: 'border-box', outline: 'none' }} />
                </div>
            ...
            <div>
              ...
              <div style={{ position: 'relative', minHeight: '140px', border: '2px dashed #d97706', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fdfbf7', padding: '24px', boxSizing: 'border-box' }}>
                ...
                {imagePreviews.length === 0 ? (
                  /* Standard Upload Empty State view */
                  <>
                    ...
                    {/* Input layer active only when no pictures exist to prevent click interception */}
                  ...
                  /* Active Thumbnail Dashboard State - Inside the box cleanly */
                  <div style={{ width: '100%' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWidth: '700', color: '#6b5446', marginBottom: '10px', letterSpacing: '0.05em' }}>
            ...
            {/* Submit Button */}
            <button type="submit" style={{ width: '100%', height: '56px', backgroundColor: '#d97706', color: '#ffffff', borderRadius: '14px', fontSize: '16px', fontWeight: '700', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer', transition: 'background-color 0.2s', marginTop: '12px', boxSizing: 'border-box' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#b45309'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#d97706'} >
